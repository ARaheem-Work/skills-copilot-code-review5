...
initial_announcements = [
    {
        "_id": "welcome-fall-registration",
        "message": "Fall activity registration is open now. Submit roster changes by Friday.",
        "start_date": None,
        "expires_at": (datetime.now(timezone.utc) + timedelta(days=90)).date().isoformat(),
